...
이 프로젝트는 기능 아이디어를 혼자 떠올리면서 시작한 게 아니라, **실제 간담회에서 나온 한 사람의 필요**에서 시작됐습니다.

당시 저는 AI를 업무에 많이 활용하고 있었고, 한 리더에게 이렇게 물었습니다.

**“요즘 제가 AI를 많이 활용하고 있는데, AI로 프로그램을 하나 만들어드릴 수 있다면 어떤 게 필요하세요?”**

답은 거창한 업무 자동화나 대시보드가 아니었습니다.

그분은 간담회를 자주 하면서 많은 사람들을 만나는데, 나중에 다시 만났을 때 그 사람을 잘 기억하지 못하거나 이전에 나눴던 사소한 이야기까지 떠올리지 못하면 미안하다고 했습니다.

원한 건 오히려 아주 인간적인 기능이었습니다. 다음에 다시 만날 사람이 있다면 미리 **누구였는지, 지난번에 무슨 이야기를 했는지, 무엇을 부탁하거나 약속했는지, 그리고 아주 사소한 이야기라도 하나 기억해서 먼저 말을 건넬 수 있었으면 좋겠다**는 것이었습니다.

그 이야기를 듣고 문제를 다시 정의했습니다.

**“회의를 잘 요약하는 프로그램”이 아니라, “사람과 사람 사이의 대화가 다음 만남까지 이어지게 하는 기억 시스템”을 만들자.**

그래서 다음 만남 전에 이런 질문에 답할 수 있도록 설계했습니다.

- 지난번에 내가 이 사람에게 무엇을 말했는가?
- 이 사람이 나에게 무엇을 말하거나 요청했는가?
- 서로 무엇을 약속했는가?
- 아직 해결되지 않았거나 기한이 지난 것은 무엇인가?
- 다음에 만났을 때 자연스럽게 다시 꺼낼 수 있는 작은 이야기는 무엇인가?
